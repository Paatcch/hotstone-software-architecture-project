...
import hotstone.variants.MinionDecisionStrategy.FixedMinionDecisionStrategy;
...
public class EpsilonStoneTestStubFactory implements HotStoneFactory {

    private MinionDecisionStrategy minionDecisionStrategy = new FixedMinionDecisionStrategy();
